// ─── Stocks ───
export const stocks = [
  { symbol: 'NVDA', name: 'NVIDIA Corp', sector: 'Semiconductors', price: 875.28, change: 2.45, signal: 'Bullish', confidence: 94, logo: 'NV' },
  { symbol: 'TSLA', name: 'Tesla Inc', sector: 'Auto Manufacturers', price: 172.40, change: -1.82, signal: 'Risky', confidence: 82, logo: 'TS' },
  { symbol: 'AAPL', name: 'Apple Inc', sector: 'Consumer Electronics', price: 168.90, change: 0.15, signal: 'Neutral', confidence: 65, logo: 'AA' },
  { symbol: 'PLTR', name: 'Palantir Technologies', sector: 'Software', price: 24.80, change: 4.2, signal: 'Bullish', confidence: 91, logo: 'PL' },
  { symbol: 'AMD', name: 'Advanced Micro Devices', sector: 'Semiconductors', price: 164.20, change: 3.12, signal: 'Bullish', confidence: 88, logo: 'AM' },
  { symbol: 'CRWD', name: 'CrowdStrike Holdings', sector: 'Cybersecurity', price: 285.50, change: -1.45, signal: 'Risky', confidence: 76, logo: 'CR' },
  { symbol: 'MSFT', name: 'Microsoft Corp', sector: 'Software', price: 415.10, change: 1.1, signal: 'Bullish', confidence: 85, logo: 'MS' },
  { symbol: 'XOM', name: 'ExxonMobil', sector: 'Energy', price: 112.80, change: 2.3, signal: 'Bullish', confidence: 81, logo: 'XO' },
];

export const topPick = {
  symbol: 'PLTR', name: 'Palantir Technologies', sector: 'Tech', price: 24.80, change: 4.2,
  signal: 'Strong Bullish', confidence: 91, rank: 1,
  trendStrength: 87, volumeSpike: '2.3x avg', momentum: 'Bullish',
...
export const dashboardMetrics = {
  ...
  sentiment: 78, sentimentLabel: 'Bullish Momentum', techInflow: '+1.4%',
  ...
  bullishVsBearish: { bull: 70, bear: 30, mixed: 45 },
};
...
export const stockDetails = {
  NVDA: {
    ...
    signal: 'Strong Bullish', confidence: 92,
    ...
    timeHorizon: 'Short/Medium Term (1-3 wks)', targetPrice: '$865.00',
    aiSummary: 'Strong Bullish momentum with breakout confirmation above key resistance. Volume surge indicates institutional participation.',
    aiExplanation: "NVIDIA's stock just pushed past a stubborn $815 resistance ceiling with 145% above-average volume. This breakout, combined with positive sentiment alignment, suggests the path is open for a move toward $850-$865 in the near term.",
    ...
    contextInsights: [
      ...
      { title: 'MACD Bullish Crossover', strength: 'Strong', color: 'blue', text: 'The MACD line crossed above the signal line in positive territory, a classic momentum indicator supporting the uptrend.' },
    ...
    risk: { level: 45, reward: 82, ratio: '1:3', riskAmt: '$16.79', rewardAmt: '$42.21', entry: '$815 - $825', stopLoss: 'Below $798' },
    warnings: [
      ...
      { title: 'False Breakout', text: 'If the price drops back and closes below $800, this bullish setup is completely invalidated.' },
    ],
    chartData: [
  ...
  TSLA: {
    ...
    signal: 'Risky', confidence: 78,
    volume: '32.1M', volumeChange: '+45%', rsi: 42.1, momentum: 'Weak', volatility: 'High', iv: '38.2%',
    conclusion: 'Bearish Pressure Continues',
    conclusionText: 'Technical breakdown continuing with elevated probability of further downside.',
    timeHorizon: 'Short Term (1-2 wks)', targetPrice: '$155.00',
    aiSummary: 'Risky signal with bearish momentum. Distribution patterns forming with declining institutional support.',
    aiExplanation: 'Tesla is showing a double top formation validated by bearish MACD crossover. Insider selling cluster detected over last 7 days.',
    confidenceDrivers: ['Bearish pattern', 'Volume decline', 'Insider selling'],
    contextInsights: [
      { title: 'Double Top Formation', strength: 'Strong', color: 'red', text: 'Classic bearish reversal pattern confirmed at the $180 level.' },
      { title: 'Declining Volume', strength: 'Medium', color: 'amber', text: 'Buying volume has decreased 30% over the past 5 sessions.' },
      { title: 'Bearish MACD', strength: 'Strong', color: 'red', text: 'MACD crossed below signal line, confirming downward momentum.' },
    ...
    risk: { level: 72, reward: 35, ratio: '2:1', riskAmt: '$22.40', rewardAmt: '$17.40', entry: 'Avoid', stopLoss: 'N/A' },
    warnings: [
  ...
  AMD: {
    ...
    timeHorizon: 'Short Term (1-2 wks)', targetPrice: '$178.00',
    aiSummary: 'Bullish momentum building with volume confirmation and options flow support.',
    aiExplanation: 'AMD is showing strong accumulation patterns with volume 82% above average. Supply zone broken with call buying at $170 strike.',
    ...
    risk: { level: 38, reward: 75, ratio: '1:2.5', riskAmt: '$14.20', rewardAmt: '$13.80', entry: '$160 - $165', stopLoss: 'Below $150' },
    warnings: [
...
export const assistantResponses = {
  ...
  'Why is TCS bullish right now?': {
    summary: 'TCS (Tata Consultancy Services) is displaying a confirmed bullish momentum structure, driven by a surge in large-cap cloud transformation deals and a favorable currency tailwind.',
    catalysts: [
    ...
    signalStatus: 'Bullish', confidence: 93, action: 'Consider Entry', actionTarget: 'Target: ₹4,100',
    momentum: { rsi: '62.4 ↑', macd: 'Bullish Cross' },
...
export const portfolios = {
  'Growth Portfolio': {
    ...
    holdings: [
      { symbol: 'NVDA', name: 'NVIDIA', price: 875.28, shares: 120, signal: 'Strong Bull', confidence: 92, risk: 'High', change: 2.45 },
      { symbol: 'MSFT', name: 'Microsoft', price: 415.10, shares: 200, signal: 'Bullish', confidence: 85, risk: 'Low', change: 1.1 },
      { symbol: 'TSLA', name: 'Tesla', price: 175.34, shares: 150, signal: 'Risky', confidence: 78, risk: 'High', change: -1.82 },
      { symbol: 'AAPL', name: 'Apple', price: 168.45, shares: 300, signal: 'Neutral', confidence: 65, risk: 'Low', change: 0.15 },
      { symbol: 'XOM', name: 'ExxonMobil', price: 112.80, shares: 250, signal: 'Bullish', confidence: 81, risk: 'Medium', change: 2.3 },
    ],
  ...
  'Balanced Portfolio': {
    ...
    holdings: [
      { symbol: 'MSFT', name: 'Microsoft', price: 415.10, shares: 100, signal: 'Bullish', confidence: 85, risk: 'Low', change: 1.1 },
      { symbol: 'AAPL', name: 'Apple', price: 168.45, shares: 250, signal: 'Neutral', confidence: 65, risk: 'Low', change: 0.15 },
      { symbol: 'XOM', name: 'ExxonMobil', price: 112.80, shares: 300, signal: 'Bullish', confidence: 81, risk: 'Medium', change: 2.3 },
      { symbol: 'AMD', name: 'AMD', price: 164.20, shares: 80, signal: 'Bullish', confidence: 88, risk: 'Medium', change: 3.12 },
    ],
  ...
  'Defensive Portfolio': {
    ...
    holdings: [
      { symbol: 'AAPL', name: 'Apple', price: 168.45, shares: 400, signal: 'Neutral', confidence: 65, risk: 'Low', change: 0.15 },
      { symbol: 'XOM', name: 'ExxonMobil', price: 112.80, shares: 350, signal: 'Bullish', confidence: 81, risk: 'Medium', change: 2.3 },
      { symbol: 'MSFT', name: 'Microsoft', price: 415.10, shares: 50, signal: 'Bullish', confidence: 85, risk: 'Low', change: 1.1 },
    ],
